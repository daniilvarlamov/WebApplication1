...
data merge entity @s {Tags:["obj.animaton1"],item:{id:"minecraft:potion",Count:1b,tag:{CustomModelData:1}}}
...
scoreboard players operation *gametime main_score %= *2400 const
