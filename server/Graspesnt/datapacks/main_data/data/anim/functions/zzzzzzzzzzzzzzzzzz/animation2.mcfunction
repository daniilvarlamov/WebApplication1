...
data merge entity @s {Rotation:[-90F,0F],Tags:["obj.animaton2"],item:{id:"minecraft:potion",Count:1b,tag:{CustomModelData:4}}}
...
scoreboard players operation *gametime main_score %= *300 const
