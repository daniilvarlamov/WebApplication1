...
data merge entity @s {Rotation:[-90F,0F],Tags:["obj.lamp"],item:{id:"minecraft:potion",Count:1b,tag:{CustomModelData:3}}}
...
scoreboard players operation *gametime main_score %= *160 const
